...
if('POST' == $_SERVER['REQUEST_METHOD']){
    ...
    header("Location: http://localhost/delfinai-php/017/index.php");
    die;
}
...
<body >
    ...
    <a href="http://localhost/delfinai-php/017/index.php"><?= $cat ?></a>
    <form action="http://localhost/delfinai-php/017/index.php" method="post">
