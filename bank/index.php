            ...
            if(isset($_POST['asmensKodas']) &&  preg_match("/^[3-9][0-9]{2}(0[1-9]|1[0-2])(0[1-9]|[1-2][0-9]|3[0-1])[0-9]{4}$/", $_POST['asmensKodas'])){
                foreach($sarasas as $objektas){
                    ...
                    if($sutampa == 0){
                        ...
                        header("Location: http://localhost/delfinai-php/bank/index.php");
                        die;
                    }
        }
...
<body>
    ...
    <div style="display: flex; flex-direction: column; ">
        <form action="http://localhost/delfinai-php/bank/index.php" method="post">
            Jūsų vardas:<input type="text" name="vardas" required>
            Jūsų Pavardė:<input type="text" name="pavarde" required>
            Jūsų asmens kodas:<input type="number" name="asmensKodas" min="10000000000" max="99999999999" required>
            Jūsų sąskaitos numeris<input type="text" name="saskaitosNumeris"
