        ...
        foreach($sarasas as $index => $value){
            if($indexPasirinkto == $index){
                if($sarasas[$index]['likutis'] == 0){
                    ...
                    echo 'PASKYRA BUVO ISTRINTA';
                    file_put_contents(__DIR__ . '/data.json', json_encode($sarasas));
                    
                }else{
                    echo 'NEPAVYKO ISTRINTI PASKYROS. SASKAITOJE YRA ' . $sarasas[$index]['likutis'] . ' Eur';
...
<body>
        ...
        <a href="http://localhost/delfinai-php/bank/sarasas.php">Grįžti</a>
</body>
</html>